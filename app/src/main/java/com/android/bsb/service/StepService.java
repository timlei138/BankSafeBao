...
import com.android.bsb.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "onCreate()");
        mStepDb = LocalDataManager.getInstance(getApplicationContext()).getBoxStore().boxFor(StepData.class);
        initNotification();
        initTodayData();
    ...
    private void initTodayData() {
        ...
        //获取当天的数据，用于展示
        List<StepData> list = mStepDb.find(StepData_.today,CURRENT_DATE);
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void updateNotification() {
        ...
        //PendingIntent hangPendingIntent = PendingIntent.getActivity(this, 0, null, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    public void onDestroy() {
        ...
        //取消前台进程
        stopForeground(true);
        mStepDb.closeThreadResources();
        unregisterReceiver(mBatInfoReceiver);
        AppLogger.LOGD(TAG,"stepService关闭");
    }
