...
public class LeftSlideView extends HorizontalScrollView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            mDetailBtn = findViewById(R.id.item_delete);
            mUpdateBtn = findViewById(R.id.item_update);
            mDeleteBtn = findViewById(R.id.item_delete);
            once = true;
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed) {
            ...
            mScrollWidth = mDetailBtn.getWidth() + mUpdateBtn.getWidth()+mDeleteBtn.getWidth();
        }
    }
