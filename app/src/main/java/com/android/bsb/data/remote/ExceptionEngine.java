...
public class ExceptionEngine {
    ...
    public static ApiException handleException(Throwable e){
        ...
        if (e instanceof HttpException){             //HTTP错误
            ...
            ex = new ApiException(e, AppError.HTTP_ERROR);
            ...
            ex = new ApiException(e, AppError.PARSE_ERROR);
            ex.setDisplayMessage("解析错误");            //均视为解析错误
            return ex;
        }else if(e instanceof ConnectException){
            ex = new ApiException(e, AppError.NETWORD_ERROR);
            ex.setDisplayMessage("连接失败");  //均视为网络错误
            return ex;
        }else {
            ex = new ApiException(e, AppError.UNKNOWN);
